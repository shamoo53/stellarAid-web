...
export const RadioOption: React.FC<RadioOptionProps> = ({ id, name, value, label, checked, onChange }) => {
  ...
  return (
    ...
    >
      ...
      />
      <span style={{ fontSize: "14px", color: "#1e293b", fontWeight: checked ? "500" : "400" }}>
        {label}
      </span>
    </label>
  );
